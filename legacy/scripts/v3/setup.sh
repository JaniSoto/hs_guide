# ==============================================================================
# 1. CREATE start-kde.sh
# ==============================================================================
sudo tee /usr/local/bin/start-kde.sh > /dev/null << 'ENDOFSCRIPT'
#!/usr/bin/env bash
set -euo pipefail
...
# The Fix: Completely power down the display stack and wait for AMD to flush DRM planes
...
# ==============================================================================
# 2. CREATE start-gaming.sh
# ==============================================================================
sudo tee /usr/local/bin/start-gaming.sh > /dev/null << 'ENDOFSCRIPT'
#!/usr/bin/env bash
set -euo pipefail
...
# The Fix: Disable the Bazzite user-level sunshine service to prevent gamescope conflicts
...
# ==============================================================================
# 3. CREATE stop-session.sh
# ==============================================================================
sudo tee /usr/local/bin/stop-session.sh > /dev/null << 'ENDOFSCRIPT'
#!/usr/bin/env bash
set -euo pipefail
...
echo -e "\n🎉 ALL SCRIPTS INSTALLED AND KMS RACE CONDITIONS FIXED."
