...
**1c — Enable login persistence and reboot:**
...
**3b — Enable the Sunshine service:**
...
1. **Connect VPN** — Open WireGuard on your device and activate your profile. Your server becomes accessible at `10.8.0.1`.
...
WireGuard VPN and Sunshine are running. You can stream your desktop or Gaming Mode over an encrypted VPN tunnel.
